...
| DS-11 | 收尾复核确认的字体、焦点、表单、通知、日期入口与规范冲突；Cindy 两模式逐项前后对照，Mobile 仅既有 Sheet 减弱动效接线 | 有意可见 / 交互修复 | Draft [#4455](https://github.com/makecindy/cindy/pull/4455)，历史实现已完成自审与单测；结合最新 main 的增量验证另记；[方案、结果与证据边界](../design-evidence/2026-09-15/ds11-review-fixes.md)；接续 DS-10，独立审查与用户最终视觉验收分别跟进 |
