...
| [`apps/desktop/resources/system-skills/skill-creator/license.txt`](../../apps/desktop/resources/system-skills/skill-creator/license.txt) | OpenAI Codex `skill-creator` | 改编并随 Desktop 分发的内置 Skill，上游许可证必须与资源相邻保留。 |
